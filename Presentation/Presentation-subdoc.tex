...
% $URL: https://forge.cornell.edu/svn/repos/lv39_papers/SynLBD/text/SJIAOS2015/Presentation/Presentation-subdoc.tex $
\section{Context}
\begin{frame}
\begin{block}{Funding}
\begin{itemize}
...
\alert<1>{    \State {Assign all $j \in K_t^\prime$ to $J_{k^\prime s}^-$ for $t \leq s \leq t+n$}
...
%This model may not be the best fit for the data...
%\end{block}
%\end{frame}
